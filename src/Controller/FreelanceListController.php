...
class FreelanceListController extends BaseController {
    ...
    public function get(): void
    {
        ...
        $freelances = $this->freelanceRepository->findAllPaginated($perPage, $offset);

        // Carrega a view
        require __DIR__ . '/../View/freelance/list.php';
    }
}
