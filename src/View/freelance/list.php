...
<div class="container py-5">
  ...
  <?php if (empty($freelances)): ?>
    <div class="alert alert-info">Nenhum freelance encontrado.</div>
  <?php else: ?>
          ...
          <div class="card bg-dark text-white h-100">
            <div class="card-body d-flex flex-column">
              ...
              <small class="text-muted mb-3 d-block">
                Proprietário: <?= htmlspecialchars($f->getUser()->getName()) ?>
              </small>
    ...
    <!-- Paginação -->
    <?php if ($totalPages > 1): ?>
      <nav aria-label="Paginação de freelas" class="mt-5">
